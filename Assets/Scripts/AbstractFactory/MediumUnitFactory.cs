...
{
    public class MediumUnitFactory: MonoBehaviour, IUnitFactory
    {
        private GameObject unitPrefab;
        private GameObject slash;
        private Tilemap tilemap;
        private int damagePlayer;
        public MediumUnitFactory(GameObject prefab, GameObject slash, Tilemap tilemap, int damagePlayer)
        {
            unitPrefab = prefab;
        ...
        {
            int numberOfUnits = Random.Range(5, 7);  // Случайное количество юнитов от 3 до 5
